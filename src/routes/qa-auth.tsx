  ...
  const securityChecks: Check[] = useMemo(
    () => [
      ...
      },
      {
        ...
        status: "warn",
        nonCritical: true,
        detail: "Ingredients, Recipes, Menu Analytics, Price Log, and Snapshots are Supabase-backed (Build 1.5). Dashboard, dish analysis, impact cascade, and alerts remain mock/future.",
      },
    ],
    [],
  );
