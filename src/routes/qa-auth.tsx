  ...
  const securityChecks: Check[] = useMemo(
    () => [
      ...
      },
      {
        ...
        status: "warn",
        nonCritical: true,
        detail: "Ingredients, Recipes, and Menu Analytics are Supabase-backed (Build 1.4). Dashboard, dish analysis, price log, snapshots, impact cascade, and alerts remain mock/future.",
      },
    ],
    [],
  );
