...
## Expected public tables (22)

`profiles`, `restaurants`, `restaurant_members`, `restaurant_settings`, `restaurant_invitations`, `units`, `unit_conversions`, `menu_categories`, `suppliers`, `ingredients`, `ingredient_cost_state`, `recipes`, `recipe_lines`, `price_update_batches`, `ingredient_price_log`, `ingredient_snapshots`, `impact_cascade_runs`, `impact_cascade_items`, `alerts`, `billing_customers`, `billing_subscriptions`, `billing_events`.
